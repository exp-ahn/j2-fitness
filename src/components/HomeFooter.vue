                ...
                <div class="footer-right">
                    <div class="flex">
                        <div class="footer-info-wrap">
                            <h6 class="footer-info mb-2">예약 / 상담 / 문의</h6>
                            <h5 class="footer-info mb-3">Tel. 051-891-8766</h5>
                        </div>
                        <div class="contact-small-circles">
...
.contents-small-circles,
.contact-small-circles {
    display: flex;
}
