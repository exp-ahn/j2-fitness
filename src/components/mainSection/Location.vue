            ...
            <div>
                <div class="d-flex justify-content-center">
                    <div
                        ...
                        @click="openNewTab('https://map.naver.com/p/entry/place/1020692862?c=15.00,0,0,0,dh')"
                    >
                    ...
                    <div
                        ...
                        @click="openNewTab('https://map.kakao.com/?map_type=TYPE_MAP&itemId=889644700')"
                    >
...
.naver-map-button > img:first-child {
    width: 45px;
    height: 45px;
    object-fit: contain;
    margin-right: 10px;
...
.naver-map-button > img:last-child {
    width: 120px;
    height: 52px;
    object-fit: contain;
}
